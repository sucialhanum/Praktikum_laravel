...
<body>
    ...
    <div class="container">
        <div class="row mt-3">
            ...
            <div class="col"></div>
            <div class="col-1">
                <a href="{{ route('aktivitas') }}" style="text-decoration: none; margin-right: 15px"
                    class="text-end text-black fw-semibold">Aktivitas</a>
            </div>
            <div class="col-1">
                <a href="{{ route('berita') }}" style="text-decoration: none; margin-right: 15px"
                    class="text-end text-black fw-semibold">Berita</a>
            </div>
            <div class="col-1">
                <a href="{{ route('profile') }}" style="text-decoration: none; margin-right: 15px"
                    class="text-end text-black fw-semibold">Profil</a>
            </div>
            <div class="col-1">
                <a href="{{ route('logout') }}" style="text-decoration: none" class="text-end text-black fw-semibold">
                    Logout
                </a>
            </div>
        </div>
